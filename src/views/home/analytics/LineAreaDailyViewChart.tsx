...
const LineAreaDailyViewChart = () => {
  ...
  return (
    <Card className='pbe-6'>
      <CardHeader title='Average Daily Views' className='pbe-3' />
      <CardContent>
        <Typography>Total Views This Month</Typography>
...
export default LineAreaDailyViewChart
